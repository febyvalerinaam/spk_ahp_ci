...
<html lang="en">
    ...
    <body class="bg-gradient-success">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-success" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode AHP</a>
            </div>
        </nav>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Metode AHP</h4>
                            <p class="pt-4">
                            ...
                            <p>
                                Metode Analytical Hierarchy Process (AHP) adalah sebuah metode untuk memeringkat alternatif keputusan dan memilih yang terbaik dengan beberapa kriteria. Metode AHP mengembangkan satu nilai numerik untuk memeringkat setiap alternatif keputusan, berdasarkan pada sejauh mana tiap-tiap alternatif memenuhi kriteria pengambil keputusan.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="p-5">
										...
										<?php $error=session()->getFlashdata('message');
										if($error) {?>
