...
<?php if(session()->get('user_data')['id_user_level'] == '1'): ?>
<div class="mb-4">
    <!-- Page Heading -->
    ...
    <div class="alert alert-success">
        ...
        Selamat datang <span class="text-uppercase"><b><?= session()->get('user_data')['username']; ?>!</b></span> Anda bisa mengoperasikan sistem dengan wewenang tertentu melalui pilihan menu di bawah.
    </div>
    <div class="row">
...
<?php endif; ?>
<?php if(session()->get('user_data')['id_user_level']  == '2'): ?>
<div class="mb-4">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-home"></i> Dashboard</h1>
