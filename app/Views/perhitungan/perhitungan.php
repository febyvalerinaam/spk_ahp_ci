...
$this->Perhitungan_model = new \App\Models\PerhitunganModel();
?>
...
//							dd($sub_kriteria);
                            foreach ($sub_kriteria as $keyz):
								$nilai_prioritas = $this->Perhitungan_model
                                    ->prioritas_subkrit($keys->id_nilai,$key->id_kriteria,$keyz->id_sub_kriteria);
                                echo $nilai_prioritas ? $nilai_prioritas['nilai'] : '';
							endforeach;
						?>
						</td>
						<?php
...
<?php
echo view('layouts/footer_admin');
?>